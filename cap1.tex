...
\item Diseñar e implementar un módulo de comunicación entre el \textit{soft-core} y el procesador ARM, garantizando la transferencia de datos en tiempo real y la sincronización de eventos.\ref{fig1}
...
\begin{figure}[H]
		\centering
		\includegraphics[width=0.8\textwidth]{figs/Diagram_architecture_general.png}
...
\begin{itemize}
    ...
    \item \textbf{Capítulo 4. Implementación del Entorno de Desarrollo y Adquisición del Núcleo RISC-V:} Describe la puesta en marcha del entorno de herramientas (FuseSoC, AMD Vivado y Xilinx Vitis), la integración del núcleo Ibex en el diagrama de bloques, la generación del \textit{bitstream} y la configuración del sistema operativo Linux embebido sobre el procesador ARM.

    \item \textbf{Capítulo 5. Ensayos y Resultados:} Presenta la ejecución de las pruebas de laboratorio sobre el sistema integrado, evaluando el desempeño, la latencia de comunicación, la precisión de los \textit{timestamps} obtenidos y la confiabilidad en la captura de eventos.

    \item \textbf{Capítulo 6. Conclusiones y Trabajo Futuro:} Recapitula los resultados obtenidos, establece el grado de verificación de la hipótesis, determina el cumplimiento de los objetivos y sugiere líneas de investigación y desarrollo futuras.
\end{itemize}
