...
A continuación se presenta el Device Tree utilizado para describir
los recursos de hardware empleados por el sistema.

\begin{lstlisting}[
    style=dtsstyle,
    caption={Archivo Device Tree utilizado en el sistema.},
    label={code:dts}
]
/dts-v1/;

/ {#address-cells = <0x01>;#size-cells = <0x01>;compatible = "digilent,zynq-zybo\0xlnx,zynq-7000";model = "Zynq ZYBO Development Board";

chosen {
	stdout-path = "serial0:115200n8";
	bootargs = "console=ttyPS0,115200 root=/dev/mmcblk0p2 rw rootfstype=ext4 rootwait earlyprintk clk_ignore_unused";
};
...
amba {
	...
	slcr@f8000000 {
		#address-cells = <0x01>;
		#size-cells = <0x01>;
		compatible = "xlnx,zynq-slcr\0syscon\0simple-bus";
	...
	/* --- INICIO DEL HARDWARE IBEX (INYECCION MANUAL) --- */
	axi_gpio_ibex: gpio@41200000 {
		#gpio-cells = <0x02>;
		compatible = "xlnx,xps-gpio-1.00.a", "xlnx,axi-gpio-2.0";
		gpio-controller;
		reg = <0x41200000 0x10000>;
	};
	/* --- FIN DEL HARDWARE IBEX --- */
};

phy0 {
	compatible = "usb-nop-xceiv";
	#phy-cells = <0x00>;
	reset-gpios = <0x07 0x2e 0x01>;
	linux,phandle = <0x06>;
	phandle = <0x06>;
};

/* --- PERIFERICOS AXI AniADIDOS MANUALMENTE --- */
    
    axi_bram_ctrl_0: memory-controller@40000000 {
    ...
    /* Opcional: El AXI Reporter para la Fase 3 */
    axi_reporter_0: reporter@43c00000 {
