...
\begin{enumerate}
  ...
  único registro pasivo indiferenciado.
    \item \textbf{Captura Instantánea en Silicio:} Cuando la lógica de arbitraje del subsistema detecta una validación en el bus con la dirección de frontera reporter\_core.sv distingue el TIPO de evento por la
    direccion real que usa el firmware, no por una unica direccion: escrituras a 0x80000008 capturan EVT\_PC, a 0x8000000C capturan EVT\_I (agregado en esta ultima sesion, ver 2.7), a 0x80000010 capturan EVT\_D. El filtrado de rango general (0x8000\_0000-0x8FFF\_FFFF) lo hace la señal sel\_ts en
    ibex\_bram\_subsystem.sv, aguas arriba del Reporter.
...
Estos 8 \textit{offsets} se leen desde el lado AXI-Lite/Linux (base \texttt{0x43C00000}), y no son tres direcciones de  escritura que usa el firmware del lado del Ibex
(\texttt{0x80000008}/\texttt{0x8000000C}/\texttt{0x80000010}.
